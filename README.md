...
V18 increases the OpenAI output-token budget and adds clearer JSON parse diagnostics. Add `AI_MAX_OUTPUT_TOKENS=3200` in Netlify if AI output was being cut off mid-string.
...
## v20 note
AI timeout default increased to 55 seconds and the AI schema was tightened to reduce aborted requests while preserving the final-page insight structure. Recommended Netlify variables: OPENAI_MODEL=gpt-4.1-nano, AI_TIMEOUT_MS=22000, AI_MAX_OUTPUT_TOKENS=3200.


## v22 Netlify 504 inactivity fix
