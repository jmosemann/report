...
## v18 OpenAI timeout note
Set `AI_TIMEOUT_MS=30000` in Netlify. v18 allows up to 45000ms, but 25000ms is the recommended starting point for synchronous Netlify Functions.
...
## v18 layout and AI insight update
