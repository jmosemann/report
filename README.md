...
## v17 OpenAI timeout note
Set `AI_TIMEOUT_MS=30000` in Netlify. v17 allows up to 45000ms, but 25000ms is the recommended starting point for synchronous Netlify Functions.


## v17 AI JSON fix

V17 increases the OpenAI output-token budget and adds clearer JSON parse diagnostics. Add `AI_MAX_OUTPUT_TOKENS=3200` in Netlify if AI output was being cut off mid-string.
