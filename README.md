...
```json
{"ok":true,"keyConfigured":true,"model":"gpt-5.4-nano","message":"OpenAI key and model access look good."}
```
...
## v15 OpenAI timeout note
Set `AI_TIMEOUT_MS=25000` in Netlify. v15 allows up to 45000ms, but 25000ms is the recommended starting point for synchronous Netlify Functions.
