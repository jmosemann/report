...
## v20 note
AI timeout default increased to 55 seconds and the AI schema was tightened to reduce aborted requests while preserving the final-page insight structure. Recommended Netlify variables: OPENAI_MODEL=gpt-4.1-mini, AI_TIMEOUT_MS=55000, AI_MAX_OUTPUT_TOKENS=4500.
