...
async function createStructuredReport(apiKey, model, metrics, transcriptText, timeoutMs) {
  ...
  const body = {
    ...
    instructions: [
      ...
      'Pages 11 and 12 receive the most AI-generated insight, but every field must be short enough to fit a fixed PDF layout. Do not fill fields to their maximum length.',
...
const schema = {
  ...
  properties: {
    executiveRead: { type: 'array', items: { type: 'string', maxLength: 74 }, minItems: 4, maxItems: 4 },
    ...
    leadershipPriorities: {
      ...
      items: {
        ...
        properties: {
          ...
          priority: { type: 'string', maxLength: 74 },
          currentRead: { type: 'string', maxLength: 38 },
          status: { type: 'string', enum: ['WATCH', 'ACTION', 'GOOD'] },
          leadershipMove: { type: 'string', maxLength: 48 }
        },
    ...
    talkTrackSections: {
      ...
      items: {
        ...
        properties: {
          ...
          hits: { type: 'array', items: { type: 'string', maxLength: 58 }, minItems: 2, maxItems: 2 },
          risks: { type: 'array', items: { type: 'string', maxLength: 58 }, minItems: 2, maxItems: 2 },
          questions: { type: 'array', items: { type: 'string', maxLength: 58 }, minItems: 2, maxItems: 2 }
        },
